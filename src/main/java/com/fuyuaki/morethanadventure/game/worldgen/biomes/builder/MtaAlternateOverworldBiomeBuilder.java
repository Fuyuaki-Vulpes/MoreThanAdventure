...
import com.fuyuaki.morethanadventure.world.level.biome.MtaAlternateBiomesList;
...
public class MtaAlternateOverworldBiomeBuilder {
    ...
    protected ResourceKey<Biome> pickMiddleBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        ResourceKey<Biome> middleBiome = biomeOrFallback(MtaAlternateBiomesList.MTA_MIDDLE_BIOMES[temperatureIndex][humidityIndex], VanillaBiomeList.MIDDLE_BIOMES[temperatureIndex][humidityIndex]);

        if (weirdness.max() < 0) return middleBiome;
        else {
            return biomeOrFallback(MtaAlternateBiomesList.MTA_MIDDLE_BIOMES_VARIANT[temperatureIndex][humidityIndex], middleBiome);
        }
    }
    ...
    protected ResourceKey<Biome> pickSwampBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_SWAMP_BIOMES[temperatureIndex][humidityIndex], this.pickSwampBiomeVanilla(temperatureIndex, humidityIndex, weirdness));
    }

    protected ResourceKey<Biome> pickRiverBiomeMTA(int temperatureIndex, int humidityIndex) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_RIVER_BIOMES[temperatureIndex][humidityIndex], temperatureIndex == 0 ? Biomes.FROZEN_RIVER : Biomes.RIVER);
    }

    protected ResourceKey<Biome> pickBeachBiomeMTA(int temperatureIndex, int humidityIndex) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_BEACH_BIOMES[temperatureIndex][humidityIndex], VanillaBiomeList.BEACH_BIOMES[temperatureIndex][humidityIndex]);
    }

    protected ResourceKey<Biome> pickStonyShoresBiomeMTA(int temperatureIndex, int humidityIndex) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_STONY_SHORES_BIOMES[temperatureIndex][humidityIndex], Biomes.STONY_SHORE);
    }

    protected ResourceKey<Biome> pickIslandBiomeMTA(int temperatureIndex, int humidityIndex) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_ISLAND_BIOMES[temperatureIndex][humidityIndex], Biomes.MUSHROOM_FIELDS);
    }
    ...
    protected ResourceKey<Biome> pickPlateauBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        if (weirdness.max() < 0L)
            return biomeOrFallback(MtaAlternateBiomesList.MTA_PLATEAU_BIOMES[temperatureIndex][humidityIndex], VanillaBiomeList.PLATEAU_BIOMES[temperatureIndex][humidityIndex]);
        else
            return biomeOrFallback(MtaAlternateBiomesList.MTA_PLATEAU_BIOMES_VARIANT[temperatureIndex][humidityIndex], MtaAlternateBiomesList.MTA_PLATEAU_BIOMES[temperatureIndex][humidityIndex], VanillaBiomeList.PLATEAU_BIOMES_VARIANT[temperatureIndex][humidityIndex], VanillaBiomeList.PLATEAU_BIOMES[temperatureIndex][humidityIndex]);
    }
    ...
    protected ResourceKey<Biome> pickPeakBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_PEAK_BIOMES[temperatureIndex][humidityIndex], this.pickPeakBiome(temperatureIndex, humidityIndex, weirdness));
    }

    protected ResourceKey<Biome> pickSlopeBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_SLOPE_BIOMES[temperatureIndex][humidityIndex], this.pickPlateauBiomeMTA(temperatureIndex, humidityIndex, weirdness));
    }
    ...
    protected ResourceKey<Biome> pickExtremeHillsBiomeMTA(int temperatureIndex, int humidityIndex, Climate.Parameter weirdness) {
        return biomeOrFallback(MtaAlternateBiomesList.MTA_EXTREME_HILLS_BIOMES[temperatureIndex][humidityIndex], this.pickExtremeHillsBiomeVanilla(temperatureIndex, humidityIndex, weirdness), VanillaBiomeList.PLATEAU_BIOMES[temperatureIndex][humidityIndex]);
    }

    protected ResourceKey<Biome> pickOceanBiomes(int temperatureIndex, int humidityIndex) {

        return biomeOrFallback(MtaAlternateBiomesList.MTA_OCEANS[temperatureIndex][humidityIndex],VanillaBiomeList.OCEANS[temperatureIndex][humidityIndex]);
