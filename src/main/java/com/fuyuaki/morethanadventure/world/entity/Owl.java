...
public class Owl extends MTATameableAnimal implements FlyingAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.25, stack -> stack.is(ItemTags.VILLAGER_PLANTABLE_SEEDS), false));
        this.goalSelector.addGoal(3, new BreedGoal(this, 1.25));
        this.goalSelector.addGoal(6, new OwlWanderGoal(this, 1.0F));
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        Owl owl = MtaEntityTypes.OWL.get().create(pLevel, EntitySpawnReason.BREEDING);
        return owl;
    }
    ...
    static class OwlWanderGoal extends WaterAvoidingRandomFlyingGoal {
        public OwlWanderGoal(PathfinderMob pathfinderMob, double speed) {
