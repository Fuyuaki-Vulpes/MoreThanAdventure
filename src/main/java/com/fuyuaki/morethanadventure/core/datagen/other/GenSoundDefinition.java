...
public class GenSoundDefinition extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        //Ambience
        add(MtaSounds.AMBIENT_POLAR_WIND.value(), definition()
                .with(sound("morethanadventure:ambient/weather/polar/wind1"))
                .with(sound("morethanadventure:ambient/weather/polar/wind2"))
                .with(sound("morethanadventure:ambient/weather/polar/wind3"))
                .with(sound("morethanadventure:ambient/weather/polar/wind4"))
        ...
        add(MtaSounds.DEER_HURT.get(), definition()
        ...
        add(MtaSounds.TOUCAN_HURT.get(), definition()
        ...
        add(MtaSounds.TURKEY_HURT.get(), definition()
        ...
        add(MtaSounds.WISPFLY_HURT.get(), definition()
        ...
        add(MtaSounds.WISPFLY_DEATH.get(), definition()
        ...
        add(MtaSounds.ARMORED_SKELETON_AMBIENT.get(), definition()
        ...
        add(MtaSounds.ARMORED_SKELETON_HURT.get(), definition()
        ...
        add(MtaSounds.ARMORED_SKELETON_DEATH.get(), definition()
        ...
        add(MtaSounds.ARMORED_SKELETON_STEP.get(), definition()
        ...
        add(MtaSounds.CHARRED_SKELETON_AMBIENT.get(), definition()
        ...
        add(MtaSounds.CHARRED_SKELETON_HURT.get(), definition()
        ...
        add(MtaSounds.CHARRED_SKELETON_DEATH.get(), definition()
        ...
        add(MtaSounds.CHARRED_SKELETON_STEP.get(), definition()
        ...
        add(MtaSounds.FALLEN_SAMURAI_HURT.get(), definition()
        ...
        add(MtaSounds.FALLEN_SAMURAI_DEATH.get(), definition()
        ...
        add(MtaSounds.HOST_DEATH.get(), definition()
                .with(
        ...
        add(MtaSounds.WITHER_SOLDIER_HURT.get(), definition()
        ...
        add(MtaSounds.WITHER_SOLDIER_DEATH.get(), definition()
        ...
        add(MtaSounds.WITHER_SOLDIER_STEP.get(), definition()
        ...
        add(MtaSounds.YUKI_ONNA_AMBIENT.get(), definition()
        ...
        add(MtaSounds.YUKI_ONNA_HURT.get(), definition()
 ...
 */
        ...
        add(MtaSounds.LIGHTNING_BOLT_THUNDER_VERY_FAR.get(), definition()
                .with(
        ...
        add(MtaSounds.STOVE_CRACKLE.get(), definition()
                .with(
