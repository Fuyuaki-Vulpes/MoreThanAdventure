...
public class Owl extends Animal implements FlyingAnimal, GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.25, p_335831_ -> p_335831_.is(ItemTags.CHICKEN_FOOD), false));
