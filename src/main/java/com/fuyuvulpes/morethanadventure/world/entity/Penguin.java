...
public class Penguin extends Animal implements GeoEntity {
    ...
    public Penguin(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.25, p_335831_ -> p_335831_.is(ItemTags.FISHES), false));
